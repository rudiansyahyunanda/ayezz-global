        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12 max-w-md w-full shadow-xl border border-neutral-200/80 space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 bg-[#111111] hover:bg-neutral-800 text-white font-bold text-xs uppercase tracking-widest rounded-2xl transition-all inline-flex items-center justify-center space-x-2 active:scale-[0.99] shadow-xs whitespace-nowrap shrink-0"
            >
              <span className="whitespace-nowrap">{mode === 'login' ? 'Log Masuk' : 'Daftar Akaun'}</span>
          ...
          <div className="relative py-2 text-center">
            ...
            <span className="relative bg-white px-3 text-[10px] font-mono text-neutral-400 uppercase tracking-widest font-bold whitespace-nowrap">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              onClick={async () => {
                try {
                  const { signInWithGoogle } = await import('../../lib/authService');
                  await signInWithGoogle();
                } catch (e) {
                  setErrorMessage(e.message || 'Log masuk Google tidak dapat diteruskan.');
                }
              }}
              className="py-3 px-4 bg-[#F5F5F7] hover:bg-neutral-200 border border-neutral-200 text-[#111111] text-xs font-bold rounded-2xl transition-all inline-flex items-center justify-center space-x-2 active:scale-95 cursor-pointer whitespace-nowrap shrink-0"
            >
            ...
            <button
              ...
              className="py-3 px-4 bg-[#111111] hover:bg-neutral-800 text-white text-xs font-bold rounded-2xl transition-all inline-flex items-center justify-center space-x-2 shadow-xs active:scale-95 cursor-pointer whitespace-nowrap shrink-0"
            >
              <svg className="w-4 h-4 fill-current shrink-0" viewBox="0 0 170 170">
                <path d="M150.37 130.25c-2.45 5.66-5.35 10.87-8.71 15.66-4.58 6.53-8.33 11.05-11.22 13.56-4.48 4.12-9.28 6.23-14.42 6.35-3.69 0-8.14-1.05-13.32-3.18-5.19-2.12-9.97-3.17-14.34-3.17-4.58 0-9.49 1.05-14.75 3.17-5.26 2.13-9.5 3.24-12.74 3.35-4.82.13-9.68-1.97-14.57-6.3-3.23-2.76-7.14-7.46-11.75-14.09-6.39-9.23-11.66-19.8-15.82-31.72-4.16-11.92-6.24-23.36-6.24-34.33 0-14.28 3.52-25.86 10.57-34.73 7.04-8.88 15.88-13.37 26.53-13.48 4.7 0 9.77 1.15 15.22 3.44 5.45 2.3 9.4 3.44 11.84 3.44 2.17 0 6.06-1.15 11.66-3.44 5.61-2.29 10.37-3.38 14.29-3.38 12.02.47 21.6 4.9 28.74 13.29-10.74 6.47-16.01 15.42-15.81 26.85.2 11.43 5.76 20.67 16.68 27.72-3.41 9.87-8.15 19.38-14.23 28.53zM119.22 31.09c0-7.07 2.53-13.88 7.59-20.43 5.06-6.55 11.53-10.39 19.4-11.52.28 1.4.42 2.76.42 4.08 0 7.21-2.6 14.16-7.8 20.85-5.2 6.69-11.71 10.54-19.53 11.55-.07-1.12-.08-2.63-.08-4.53z"/>
              </svg>
