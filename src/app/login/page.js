        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12 max-w-md w-full shadow-xl border border-neutral-200/80 space-y-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="py-3 px-4 bg-[#F5F5F7] hover:bg-neutral-200 border border-neutral-200 text-[#111111] text-xs font-bold rounded-2xl transition-all flex items-center justify-center space-x-2 active:scale-95 cursor-pointer"
            >
            ...
            <button
              ...
              className="py-3 px-4 bg-[#111111] hover:bg-neutral-800 text-white text-xs font-bold rounded-2xl transition-all flex items-center justify-center space-x-2 shadow-xs active:scale-95 cursor-pointer"
            >
