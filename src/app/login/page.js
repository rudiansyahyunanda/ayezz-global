        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12 max-w-md w-full shadow-xl border border-neutral-200/80 space-y-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              onClick={async () => {
                try {
                  ...
                  setErrorMessage(e.message || 'Log masuk Google memerlukan konfigurasi Provider di Supabase.');
                }
              }}
              className="py-3 px-4 bg-[#F5F5F7] hover:bg-neutral-200 border border-neutral-200 text-[#111111] text-xs font-bold rounded-2xl transition-all flex items-center justify-center space-x-2"
            >
            ...
            <button
              ...
              onClick={async () => {
                try {
                  const { signInWithApple } = await import('../../lib/authService');
                  await signInWithApple();
                } catch (e) {
                  setErrorMessage(e.message || 'Log masuk Apple ID memerlukan konfigurasi Provider di Supabase.');
                }
              }}
              className="py-3 px-4 bg-[#111111] hover:bg-neutral-800 text-white text-xs font-bold rounded-2xl transition-all flex items-center justify-center space-x-2 shadow-xs"
            >
